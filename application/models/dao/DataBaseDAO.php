<?php if(! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class DataBaseDAO extends CI_Model{
		...
		public function __construct(){
			parent::__construct();
				$this->load->database(); 			       $this->create_table_tipo_funcao();
				$this->create_table_tipo_atividade();      $this->create_table_conferencia();
				$this->create_table_instituicao();         $this->create_table_regra();
				$this->create_table_comite(); 		       $this->create_table_localidade();
				...
				$this->create_table_contato();             $this->create_table_email();
				$this->create_table_telefone(); 	       $this->create_table_executa();
				$this->create_table_abriga();              $this->create_table_apoia();
				$this->create_table_submissao();           $this->create_table_avaliacao();
				$this->create_table_contem();              $this->create_table_metodo();
				$this->create_table_permissao();           $this->create_table_tipo_usuario();
