...
class OrganizadorDAO extends UsuarioDAO{
    ...
    public function consultarCodigo($codigo){
        ...
        $this->organizador->setInstituicao($instituicao);
        ...
        $this->organizador->setSenha($consulta->user_pass);
        $this->organizador->setStatus($consulta->user_status);
        $this->organizador->setToken($consulta->user_token);
        $this->consultaEndereco($this->organizador);
