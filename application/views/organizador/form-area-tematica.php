...
<?php
    echo form_open_multipart( $this->uri->segment(2) != 'alterar' ? 'eixo-tematico/cadastrar/' : $this->uri->uri_string(), 'role="form" class="formsignin"' );
?>
    ...
    <div class="col-md-12">
        ...
        <?php $data = array( 'name' => 'nome', 'placeholder' => "Denominação", 
            'class' => 'form-control estilo-input',
             'value' => (isset($areaTematica) ? $areaTematica->mote_nm : '') );
...
<div class="row">
    <div class="col-md-12">
        ...
        <textarea name="descricao" class="estilo-input" placeholder="Descrição" rows="10"><?php echo  (isset($areaTematica) ? $areaTematica->mote_desc : ''); ?></textarea>
        </div>
    </div>
</div>
