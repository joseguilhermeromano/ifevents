<div class="container-fluid">
    <h2> <span class="glyphicon glyphicon-list"> </span> <b> Inscrições </b> </h2>
    <hr>
    <br>
                         ...
                         ?>
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-2"> <div class="text-left" style="display: inline-block">
                                            <a class="btn-opcao" href="<?php echo base_url('inscricao/atribuir-presenca/'.$item->insc_cd);?>">
                                                    <span class="fa fa-check-square-o"></span>&#09;Atribuir Presença
                                            </a><br>

                                            <a href="<?= base_url('inscricao/atribuir-falta/'.$item->insc_cd);?>" class="btn-opcao">
                                                    <span class="fa fa-square-o"></span>&#09;Atribuir Falta
                                            </a>
