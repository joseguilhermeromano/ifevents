<h2> <span class="glyphicon glyphicon-blackboard"> </span> <b> Instituição </b> </h2>
<hr>
<br>
...
<?php
  if(!empty($content)):
    ...
    <tr>
      ...
      <td class="text-center"><?php echo $item->inst_abrev; ?></td>
      <td class="text-center"><?php echo $item->inst_desc; ?></td>
      <td class="text-center"><a href="<?php echo base_url('/instituicao/alterar/'.$item->inst_cd); ?>"><span class="glyphicon glyphicon-edit estilo-botao-edicao"></span></a></td>
