      ...
      <div class="panel panel-default">
        ...
        <div id="collapseOne" class="panel-collapse collapse in">
          <div class="panel-body">
            ...
            <h4>Título da Programação</h4>

            <hr>
            <div class="row">
              <div class="col-md-3">
                  <i class="fa fa-calendar" aria-hidden="true"></i> Data: 17/10/2016
                  &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-users" aria-hidden="true"></i> Vagas: 10/30
                  
              </div>
              <div class="col-md-3">
                  <i class="fa fa-clock-o" aria-hidden="true"></i> Início: 19:00
                  &nbsp;&nbsp;<i class="fa fa-clock-o" aria-hidden="true"></i> Término: 21:00
              </div>
              <div class="col-md-3">
                  <span class="glyphicon glyphicon-hourglass"></span> Duração: 120 min
                  &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-map-marker" aria-hidden="true"></i> Sala: F04
              </div>
              <div class="col-md-3">
            ...
            <br><br>
            <i class="fa fa-users" aria-hidden="true"></i> Responsáveis: Profº Raquel Fernandes de Oliveira 
            e Profº Antônio Cerqueira 
            <br><br>
            <p>
            Descrição...
            </p>
