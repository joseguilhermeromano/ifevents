        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="0"><div style="height: 30px; line-height: 30px; font-size: 10px;"></div>
            <tr><td align="center">
                        <a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; float:left; width:100%; padding:20px;text-align:center; font-size: 13px;">
                                    ...
                                    <img src="<?= base_url('assets/area-interna/img/logo_ifevents.svg'); ?>" width="200" alt="IFEvents" border="0"  /></font></a>
                    </td>
                    <td align="right">
                <!--[endif]--><!-- 
            ...
            <tr><td align="center">
                <div style="line-height: 24px;">
                    ...
                    <span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
                        Exmo(a) Sr(a) <b>José Guilherme Romano</b>, desejamos saber se você pode nos ajudar
                        na revisão dos trabalhos para o evento científico <b>5ª SEMCITEC</b>, que ocorrerá entre o período dos dias <b>11/05/2017</b> até <b>11/05/2017</b>.
                    </span></font>
                </div>
                <!-- padding --><div style="height: 40px; line-height: 40px; font-size: 10px;"></div>
            </td></tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr><td align="center" style="padding:20px;flaot:left;width:100%; text-align:center;">
                ...
                <span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
                    2017 © IFevents. Todos os direitos são reservados.
                </span></font>              
            </td></tr>          
        </table>
